...
export const DeployContractPage = () => {
  ...
  const deployVyperContract = async () => {
    ...
    const ContractDeployment = {
      provider: config?.provider, //&'a str,
      args: 'get to me next', //Box<[ConstructorArg<'a>]>
      abi: JSON.stringify(abi), //&'a str,
      initcode: initcode, //&'a str,
      private_key: wallet?.privateKey //&'a str,
    }
  ...
  return (
    <div className='flex flex-col gap-4'>
      ...
      <CreateAddressesPage args={args} setArgs={setArgs} />
